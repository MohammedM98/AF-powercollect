...
<div class="mt-4 flex items-center">
    ...
    <input type="checkbox" id="is_active" name="is_active" value="1" class="rounded border-gray-300 text-brand-600 shadow-sm" @checked(old('is_active', $user->is_active ?? true))>
