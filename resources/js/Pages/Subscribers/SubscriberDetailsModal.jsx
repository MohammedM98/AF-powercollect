                                ...
                                <div className="grid items-end gap-3 sm:grid-cols-2 lg:grid-cols-4">
                                    <label className="block text-sm text-gray-600 lg:col-span-2">
                                        ...
                                        <input
                                            ...
                                            className="mt-1 block w-full rounded-lg border-gray-300 text-sm shadow-sm focus:border-brand-500 focus:ring-brand-500"
                                        />
                                    </label>
                                    <label className="block text-sm text-gray-600">
                                        ...
                                        <input
                                            ...
                                            className="mt-1 block w-full min-w-0 rounded-lg border-gray-300 text-sm shadow-sm focus:border-brand-500 focus:ring-brand-500"
                                        />
                                    </label>
                                    <label className="block text-sm text-gray-600">
                                        إلى تاريخ
